...
<div class="box128">
	<div class="newsImage">
		<a href="{link controller='News' object=$news application='news'}{/link}"><img src="{if $news->pictureID}{@$news->getNewsPicture()->getURL()}{else}{$news->getUserProfile()->getAvatar()->getURL()}{/if}" alt="{$news->getTitle()}" style="max-width: 120px;" /></a>
	</div>

	<div class="containerHeadline">
		<h3><a data-news-id="{$news->newsID}" href="{link controller='News' object=$news application='news'}{/link}">{$news->getTitle()}</a></h3>
		<small>
			<span class="username">
			...
			-
			<a class="permalink" href="{link controller='News' object=$news application='news'}{/link}">
				{@$news->time|time}
			</a>
...
<div class="box48 simpleNews">
	<div class="newsImage">
		<a href="{link controller='News' object=$news application='cms'}{/link}"><img src="{if $news->pictureID}{$news->getNewsPicture()->getURL()}{else}{$news->getUserProfile()->getAvatar()->getURL()}{/if}" alt="{$news->getTitle()}" style="max-width: 40px;" /></a>
	</div>
	<div class="containerHeadline">
		<h3><a data-news-id="{$news->newsID}" href="{link controller='News' object=$news application='news'}{/link}">{$news->getTitle()}</a></h3>
		<small>
